...
namespace MSCUwUify
{
    public class UwUifierScript : MonoBehaviour
    {
        ...
        private static UwuifyFlag GetFlags()
        {
            ...
            if (MscUwUifyMod.Smileys.GetValue()) flags |= UwuifyFlag.Smiley;
            if (MscUwUifyMod.Stutter.GetValue()) flags |= UwuifyFlag.Stutter;
            if (MscUwUifyMod.Yu.GetValue()) flags |= UwuifyFlag.Yu;
